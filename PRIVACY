...
our application, pathya. By accessing or using our Service, you signify that you have read, understood, and
...
● Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to pathya, that is
responsible for your information under this Privacy Policy.
● Country: where pathya or the owners/founders of pathya are based, in this case is india
● Customer: refers to the company, organization or person that signs up to use the pathya Service to
...
be used to visit pathya and use the services.
...
● Personnel: refers to those individuals who are employed by pathya or are under contract to perform a
...
person.
● Service: refers to the service provided by pathya as described in the relative terms (if available) and on
this platform.
...
● App/Application: pathya app, refers to the SOFTWARE PRODUCT identified above.
● You: a person or entity that is registered with pathya to use the Services.
...
app that may include date and time; cookie number; parts of the site you viewed or searched for; and the
phone number you used to call our Customer Services. We may also use browser data such as cookies,
Flash cookies (also known as Flash Local Shared Objects) or similar data on certain parts of our app for
...
all or substantially all of the assets of pathya or any of its Corporate Affiliates (as defined herein), or that
portion of pathya or any of its Corporate Affiliates to which the Service relates, or in the event that we
...
controls, is controlled by or is under common control with pathya, whether by ownership or otherwise. Any
...
The laws of india, excluding its conflicts of law rules, shall govern this Agreement and your use of the app.
Your use of the app may also be subject to other local, state, national, or international laws.
By using pathya or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not
...
visit our site and how it's being used. By using our pathya, registering an account, or making a purchase, you
...
operated or controlled by pathya. We are not responsible for the content, accuracy or opinions expressed in
...
Cookies
pathya uses "Cookies" to identify the areas of our app that you have visited. A Cookie is a small piece of
...
You acknowledge and agree that pathya shall not be responsible for any Third-Party Services, including their
accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other
aspect thereof. pathya does not assume and shall not have any liability or responsibility to you or any other
...
greater fines for breach. Beyond these facts it's simply the right thing to do. At pathya we strongly believe
...
We are committed to helping our customers meet the data subject rights requirements of GDPR. pathya
